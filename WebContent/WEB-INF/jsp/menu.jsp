	...
	<div class="span5">
		<div class="logo">
			<a href="${pageContext.request.contextPath }/index.jsp"> <img
				src="${pageContext.request.contextPath}/image/r___________renleipic_01/logo_cn.png"
				alt="NBA商城" />
			</a>
		</div>
	</div>
			...
			<ul>
				...
				<s:else>
					...
					<li id="headerRegister" class="headerRegister"
						...
						<a href="${pageContext.request.contextPath }/order_findByUid?page=1">我的订单</a>|</li>
					<li id="headerRegister" class="headerRegister"
						style="display: list-item;"><a
